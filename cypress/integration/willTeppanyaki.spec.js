...
describe('inline reservation', () => {
  it('reservation', () => {
    ...
    cy.visit('https://inline.app/booking/-MlIX9yWDwI6MUkexSdA:inline-live-2/-MlIXA7xzJCN7mVDVBjA')
    // date choose
    ...
    */
    cy.get('.jGvTvi > .dyoxun > :nth-child(5) > :nth-child(1) > [data-cy="bt-cal-day"]').click({ force: true })
    cy.get('[data-cy="book-now-time-slot-box-12-00"]').click({ force: true })
